...
# 6. [구조 유지] 하이브리드 계산 엔진 (원본 수식 100% 유지)
...
st.data_editor(
    ...
    hide_index=True,
    key="pricing_editor",
    on_change=on_data_change # 데이터 변경 시에만 딱 한 번 실행됨
)

# 9. [구조 유지] 저장 및 불러오기 버튼
st.sidebar.markdown("---")
